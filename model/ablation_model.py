...
class PHZNet_single_block(nn.Module):
    def __init__(self, in_features=16093, out_features=16093):
        super(PHZNet_single_block, self).__init__()
        # D: depth, L: segment length
        # x: input tensor of shape (batch_size, in_features)
        self.in_features = in_features
        self.out_features = out_features
        ...
        self.phznet = nn.Sequential(
            hybrid_zipped_network_single_block(in_features, 2),
            nn.Sigmoid()
        )
...
class PHZNet_without_segmentation(nn.Module):
    def __init__(self, in_features=16093, out_features=16093):
        super(PHZNet_without_segmentation, self).__init__()
        # D: depth, L: segment length
        # x: input tensor of shape (batch_size, in_features)
        self.in_features = in_features
        self.out_features = out_features
        ...
        self.phznet = nn.Sequential(
            hybrid_zipped_network_without_segmentation(in_features, 2),
            nn.Sigmoid()
        )
...
class PHZNet_without_permute(nn.Module):
    def __init__(self, in_features=16093, out_features=16093):
        super(PHZNet_without_permute, self).__init__()
        # D: depth, L: segment length
        # x: input tensor of shape (batch_size, in_features)
        self.in_features = in_features
        self.out_features = out_features
        ...
        self.phznet = nn.Sequential(
            hybrid_zipped_network_without_permute(in_features, 2),
            nn.Sigmoid()
        )
...
class PHZNet_without_both(nn.Module):
    def __init__(self, in_features=16093, out_features=16093):
        super(PHZNet_without_both, self).__init__()
        # D: depth, L: segment length
        # x: input tensor of shape (batch_size, in_features)
        self.in_features = in_features
        self.out_features = out_features
        ...
        self.phznet = nn.Sequential(
            hybrid_zipped_network_without_both(in_features, 2),
            nn.Sigmoid()
        )
...
class hybrid_zipped_network_single_block(hybrid_zipped_network):
    def __init__(self, in_features, out_features):
        super(hybrid_zipped_network_single_block, self).__init__(in_features, out_features)
        self.hybrid_blocks = self.hybrid_blocks[:1]  # 保留一个hybrid_block


# Hybrid Zippped without segmentation Network
class hybrid_zipped_network_without_segmentation(nn.Module):
    def __init__(self, in_features, out_features):
        super(hybrid_zipped_network_without_segmentation, self).__init__()
        # D: depth, L: segment length
        # x: input tensor of shape ()
        self.in_features = in_features
        self.out_features = out_features
        ...
        self.hybrid_blocks = []
        for sl in self.seg_lengths:
            hb = hybrid_block_without_segmentation(in_features, out_features, sl).to(device)
            self.hybrid_blocks.append(hb)
...
class hybrid_block_without_segmentation(hybrid_block):
    def __init__(self, in_features=16093, out_features=16093, seg_length=7):
        super(hybrid_block_without_segmentation, self).__init__(in_features, out_features, seg_length)
...
# Hybrid Zippped without permute Network
class hybrid_zipped_network_without_permute(nn.Module):
    def __init__(self, in_features, out_features):
        super(hybrid_zipped_network_without_permute, self).__init__()
        # D: depth, L: segment length
        # x: input tensor of shape ()
        self.in_features = in_features
        self.out_features = out_features
        ...
        self.hybrid_blocks = []
        for sl in self.seg_lengths:
            hb = hybrid_block_without_permute(in_features, out_features, sl).to(device)
            self.hybrid_blocks.append(hb)
...
class hybrid_block_without_permute(hybrid_block):
    def __init__(self, in_features=16093, out_features=16093, seg_length=7):
        super(hybrid_block_without_permute, self).__init__(in_features, out_features, seg_length)
...
# Hybrid Zippped without both Network
class hybrid_zipped_network_without_both(nn.Module):
    def __init__(self, in_features, out_features):
        super(hybrid_zipped_network_without_both, self).__init__()
        # D: depth, L: segment length
        # x: input tensor of shape ()
        self.in_features = in_features
        self.out_features = out_features
        ...
        self.hybrid_blocks = []
        for sl in self.seg_lengths:
            hb = hybrid_block_without_both(in_features, out_features, sl).to(device)
            self.hybrid_blocks.append(hb)
...
class hybrid_block_without_both(hybrid_block):
    def __init__(self, in_features=16093, out_features=16093, seg_length=7):
        super(hybrid_block_without_both, self).__init__(in_features, out_features, seg_length)
